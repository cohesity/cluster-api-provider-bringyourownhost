...
// GetV1Beta1Conditions gets the ByoHost status conditions for v1beta1 compatibility
func (byoHost *ByoHost) GetV1Beta1Conditions() clusterv1.Conditions {
	return byoHost.Status.Conditions
}

// SetV1Beta1Conditions sets the ByoHost status conditions for v1beta1 compatibility
