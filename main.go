...
import (
	...
	byohcontrollers "github.com/cohesity/cluster-api-provider-bringyourownhost/controllers/infrastructure"
...
func main() {
	...
	if err = infrastructurev1beta1.SetupBootstrapKubeconfigWebhookWithManager(mgr); err != nil {
